...
class ViewDetailsInProfile extends StatefulWidget {
  ViewDetailsInProfile(this.historyId, {super.key});

  String historyId;

  @override
  State<ViewDetailsInProfile> createState() => _ViewDetailsInProfileState();
}

class _ViewDetailsInProfileState extends State<ViewDetailsInProfile> {
